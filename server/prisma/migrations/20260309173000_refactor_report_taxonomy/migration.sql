...
ALTER TABLE "CitizenReport" DROP COLUMN "type";
...
ADD CONSTRAINT "CitizenReport_mediation_check" CHECK (
    (
        "category" = 'Neighbor Disputes / Lupon'
        AND "requiresMediation" = true
        AND "mediationWarning" = 'Filing this report requires both parties to attend a face-to-face mediation hearing at the barangay hall.'
    )
    OR (
        "category" <> 'Neighbor Disputes / Lupon'
        AND "requiresMediation" = false
