...
export function DashboardSkeleton() {
  return (
    <div className="px-4 py-3.5 min-h-full space-y-4">
      ...
      <SkeletonGroup className="rounded-none border-l-[3px] border-l-gray-200 bg-white px-3.5 py-3">
      ...
      {/* Page header */}
      <SkeletonGroup className="flex flex-wrap items-start justify-between gap-3 border-b border-slate-200 pb-4">
      ...
      <div>
        ...
        <CardSkeleton
          count={4}
          variant="stat"
          gridClassName="grid grid-cols-2 lg:grid-cols-4 gap-0 border-l border-t border-slate-200"
        />
      </div>
      ...
      <div className="flex flex-wrap gap-3.5">
        {/* Map placeholder */}
        <div className="flex-[3_1_340px] bg-white overflow-hidden">
          <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3">
            <div className="flex items-center gap-2">
              <Skeleton variant="circular" className="h-4 w-4" />
        ...
        <div className="flex-[1_1_280px] bg-white">
          <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3">
          ...
          <CardSkeleton
            ...
            cardClassName="rounded-none border-0 border-b border-gray-50 px-0 py-2.5"
          />
        </div>
      </div>
...
export function IncidentsSkeleton() {
  return (
    <div className="min-h-full bg-[var(--surface)] px-4 py-4 space-y-4">
      {/* Page header */}
      <SkeletonGroup className="border-b border-slate-200 pb-4">
      ...
      {/* Filter bar */}
      <SkeletonGroup className="flex flex-wrap items-center gap-2.5 border border-slate-200 bg-white px-3.5 py-3">
...
export function CitizenDashboardSkeleton() {
  return (
    <div className="citizen-content-shell pt-4 pb-[18px] space-y-4">
      ...
      {/* Verification banner */}
      <SkeletonGroup className="rounded-xl border border-gray-200 bg-white p-4">
      ...
      <SkeletonGroup className="space-y-2">
        ...
        {[0, 1, 2].map((i) => (
          <div key={i} className="flex items-center gap-3.5 rounded-lg border border-gray-200 bg-white px-4 py-4">
      ...
      <CardSkeleton
        ...
        cardClassName="rounded-none border-x-0 border-t-0 border-b border-gray-100 px-0 py-3"
      />
    </div>
  );
}
