...
export function CitizenNotificationsPanel<T extends CitizenNotificationItem>({
  ...
  return (
    <div
      ...
      className="absolute left-4 right-4 top-11 z-[2300] max-h-[360px] w-auto overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-[0_8px_24px_rgba(15,23,42,0.2)] sm:left-auto sm:right-0 sm:w-80"
    >
